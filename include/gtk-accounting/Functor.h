#ifndef _SIGNALS_FUNCTOR_H_
#define _SIGNALS_FUNCTOR_H_
...
class Functor<void()> : public FunctorBase<void()>{
  ...
  public:
    ...
    void operator()() const { this->m_function(); }
};
...
class Functor<void(T1)> : public FunctorBase<void(T1)> {
  ...
  public:
  Functor(std::function<sig> func) : FunctorBase<sig>(func) {}
  void operator()(T1 arg1) const { this->m_function(arg1); }
};

#endif // _SIGNALS_FUNCTOR_H_
